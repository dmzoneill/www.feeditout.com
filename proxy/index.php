...
<div id="container">
  <div id="menu">
    <a href="<?php echo $_SERVER['../proxy3/PHP_SELF'] ?>">URL Form</a> | 
    <a href="../proxy3/?action=cookies">Manage Cookies</a>
  </div>
...
{
  ?>
  <form name="<?php echo $PHProxy->config['proxy_url_form_name'] ?>" method="get" action="<?php echo $_SERVER['../proxy3/PHP_SELF'] ?>">
